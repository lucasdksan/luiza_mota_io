        ...
        <>
            {
                createPortal(
                    <>
                        <div
                            className={classGenerator("vtex-menu-mobile", "login-modal-overlay")}
                            onClick={handleChangeStateModal}
                        />
                        <div className={classGenerator("vtex-menu-mobile", "login-modal")}>
                            <button onClick={handleChangeStateModal} className={classGenerator("vtex-menu-mobile", "login-modal-button")}>
                            ...
                            <div className={classGenerator("vtex-menu-mobile", "login-modal-title-area")}>
                                <span className={classGenerator("vtex-menu-mobile", "login-modal-title")}>Login</span>
                            </div>
                            <div
                                style={{
                                    width: "100%",
                                ...
                                className={classGenerator("vtex-menu-mobile", "login-modal-content-login-vtex")}
                            >
                                <LoginContent
